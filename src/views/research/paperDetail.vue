<template>
  <div class="research-page">
    ...
    <div v-else-if="error" class="empty-state">
      ...
      <h3 class="empty-title">{{ $t('research.paperNotFound') }}</h3>
      <p class="empty-text">{{ $t('research.paperNotFoundDesc') }}</p>
          ...
          <div class="hero-content">
            ...
            <nav class="breadcrumb-nav">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <router-link to="/research/papers" class="breadcrumb-link">
                    {{ $t('research.papers') }}
                  </router-link>
                </li>
                <li class="breadcrumb-item active">
                  {{ $t('research.paperDetail') }}
                </li>
              </ol>
            </nav>
            ...
            <div class="paper-meta-section">
              <div class="meta-actions">
                <span
                  v-if="paper.paperPublishTimes"
                  class="publish-date-badge"
                >
                  {{ formatDate(paper.paperPublishTimes) }}
                </span>
                <ElTooltip
...
// API请求方法
const getPaperDetail = (id: string): Promise<PaperResponse> => {
  return service.get<PaperResponse>(`/api/research/papers/${id}`) as unknown as Promise<PaperResponse>
}
...
const fetchPaperDetail = async() => {
  try {
    ...
    error.value = true
    ElMessage.error(t('research.loadError'))
  } finally {
    loading.value = false
  }
}
...
const openOriginalUrl = () => {
  if (paper.value?.originalUrl) {
    window.open(paper.value.originalUrl, '_blank')
  }
}
